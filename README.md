...
The [Rust rewrite](contract-net/rust/README.md) includes exact executors, a
WebSocket client, cost-based bidding, and offline integration checks. See its
README for build and launch commands; the Python contractor remains available below.
